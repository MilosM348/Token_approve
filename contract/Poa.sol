...
// File contracts/Poa.sol

contract Poa is ERC20, ERC20Permit, Ownable
{
    string constant TOKEN_NAME = "Poa";
    string constant TOKEN_SYMBOL = "POA";
    ...
    function mint(uint256 _mintAmount) public {
        ...
        if (msg.sender != owner()) {
            require(!paused, "require owner");
            require(_mintAmount <= maxMintAmount);
        }
        _mint(msg.sender, _mintAmount * 10**DECIMAL_PLACES);
    }
